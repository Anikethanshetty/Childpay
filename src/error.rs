...
impl ErrorMessage {
    fn to_str(&self) -> String {
        match self {
            ...
            ErrorMessage::WrongPin => "Invalid pin ".to_string(),
            ...
            ErrorMessage::EmptyPin => "Pin cannot be empty".to_string(),
            ...
            ErrorMessage::ExceededMaxPinLength(max_length) => {
                format!("Pin must not be more than {} characters", max_length)
            }
            ErrorMessage::PasswordTooShort(length) => {
                format!("Password too short: {} characters", length)
            }
            ErrorMessage::PinTooShort(length) => {
                format!("Pin too short: {} characters", length)
            }
